...
-- =============================================
    ALTER proc [dbo].[InsertOrganizationUnit] @companyID UNIQUEIDENTIFIER, @mainCurrency NVARCHAR(3), @unitType INTEGER, @IDParent UNIQUEIDENTIFIER
    as
    begin
        ...
        IF (@unitType = 0)
            BEGIN
                ...
                INSERT INTO MaterialGoodsSpecialTaxGroup(ID, CompanyID, BranchID, MaterialGoodsSpecialTaxGroupCode,
                                                         MaterialGoodsSpecialTaxGroupName, TaxRate, UnitID,
                                                         OrderFixCode,
                                                         ParentID,

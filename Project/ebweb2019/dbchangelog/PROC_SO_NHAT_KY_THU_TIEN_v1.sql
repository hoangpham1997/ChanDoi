IF OBJECT_ID ( 'PROC_SO_NHAT_KY_THU_TIEN', 'P' ) IS NOT NULL
    DROP PROCEDURE PROC_SO_NHAT_KY_THU_TIEN;
-- Author: PhuongHV'
-- Create date: 25/02/2020
-- Description:
CREATE PROCEDURE [dbo].[PROC_SO_NHAT_KY_THU_TIEN] @FromDate DATETIME ,
                                                  @ToDate DATETIME ,

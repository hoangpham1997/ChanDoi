...
-- =============================================
ALTER PROCEDURE [dbo].[Proc_BANG_KE_SO_DU_NGAN_HANG](@CompanyID UNIQUEIDENTIFIER,
                                                      @FromDate DATETIME,
                                                      @ToDate DATETIME,
    ...
    ELSE
        BEGIN
            ...
            SELECT BankAccountDetailID       as BankAccountDetailID,
                   ...
                   @CompanyName              as CompanyName,
                   NULL                      as SoDuDauKy,
                   Sum(DebitAmountOriginal)  as PhatSinhNo,
                   Sum(CreditAmountOriginal) as PhatSinhNo,
                   NULL                      as SoDuCuoiKy
            FROM @tbDataGL
            WHERE Account IN (SELECT AccountNumber From @tblListAccountNumber)
              AND PostedDate >= @FromDate
...
--               AND CompanyID = @CompanyID
            ...
            SELECT BankAccountDetailID                                    as BankAccountDetailID,
                   ...
                   BankName,
                   @CompanyName,
                   (SUM(DebitAmountOriginal) - SUM(CreditAmountOriginal)) as SoDuDauKy,
                   NULL,
                   NULL,
                   NULL
            FROM @tbDataGL

...
BEGIN
    ...
    FROM dbo.GeneralLedger GL
             INNER JOIN dbo.AccountList A ON GL.Account = A.AccountNumber AND GL.CompanyID = A.CompanyID
    ...
    FROM dbo.GeneralLedger AS GL /*edit by cuongpv dbo.GeneralLedger -> @tbDataGL*/
             ...
             LEFT JOIN dbo.AccountList A ON A.AccountNumber = I.AccountNumber AND GL.CompanyID = A.CompanyID

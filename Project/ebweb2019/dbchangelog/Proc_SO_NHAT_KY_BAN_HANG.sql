            ...
            Begin
                ...
                from (
                         select null                              as DetailID,
                                ...
                                refID,
                                nameCustomer,
                                sum(isnull(DoanhThuHangHoa, 0))   as DoanhThuHangHoa,
                                sum(isnull(DoanhThuThanhPham, 0)) as DoanhThuThanhPham,
                                sum(isnull(DoanhThuDichVu, 0))    as DoanhThuDichVu,
                                sum(isnull(DoanhThuTroCap, 0))    as DoanhThuTroCap,
                                sum(isnull(DoanhThuBDSDautu, 0))  as DoanhThuBDSDautu,
                                sum(isnull(DoanhThuKhac, 0))      as DoanhThuKhac,
                                sum(isnull(ChietKhau, 0))         as ChietKhau,
                                sum(isnull(GiaTriTraLai, 0))      as GiaTriTraLai,
                                sum(isnull(GiaTriGiamGia, 0))     as GiaTriGiamGia
                         from (

...
/**
 * A FADecrementDetailPost.
 */
@Entity
@Table(name = "fadecrementdetailpost")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class FADecrementDetailPost implements Serializable {
    ...
    @Column(name = "fadecrementdetailid")
    private UUID faDecrementDetailID;
    ...
    public UUID getFaDecrementDetailID() {
        return faDecrementDetailID;
    }

    public void setFaDecrementDetailID(UUID faDecrementDetailID) {
        this.faDecrementDetailID = faDecrementDetailID;
    }
    ...
    public boolean equals(Object o) {
        ...
        FADecrementDetailPost tIDecrementDetails = (FADecrementDetailPost) o;

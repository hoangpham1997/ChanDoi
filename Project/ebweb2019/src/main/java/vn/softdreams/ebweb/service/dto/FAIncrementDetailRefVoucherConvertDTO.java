...
public class FAIncrementDetailRefVoucherConvertDTO {
    private UUID id;
    ...
    public FAIncrementDetailRefVoucherConvertDTO() {
    }

    public FAIncrementDetailRefVoucherConvertDTO(UUID id, LocalDate date, LocalDate postedDate, String no, String reason, String totalAmountOriginal, UUID tiIncrementID, UUID refVoucherID, Integer orderPriority, Integer typeGroupID) {
        this.id = id;
        this.date = date;

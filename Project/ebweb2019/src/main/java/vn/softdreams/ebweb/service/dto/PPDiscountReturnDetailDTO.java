...
public class PPDiscountReturnDetailDTO {
    private UUID id;
...
//    private UUID refID;
    ...
    public LocalDate getPpInVoiceDate() {
        return ppInVoiceDate;
    }

    public void setPpInVoiceDate(LocalDate ppInVoiceDate) {
        this.ppInVoiceDate = ppInVoiceDate;
    }

...
public class ReceiveBillSearchDTO {
    private UUID id;
    private UUID pPID;
    ...
    public ReceiveBillSearchDTO(UUID id, UUID pPID, Integer typeID, LocalDate date, LocalDate postedDate, String noFBook, String noMBook, String description, BigDecimal amount,

...
public class SAReceiptDebitDTO {
    ...
    public SAReceiptDebitDTO(UUID accountingObjectID, String accountingObjectCode, String accountingObjectName, BigDecimal soDuDauNam, BigDecimal soPhatSinh, BigDecimal soDaThu, BigDecimal soConPhaiThu) {

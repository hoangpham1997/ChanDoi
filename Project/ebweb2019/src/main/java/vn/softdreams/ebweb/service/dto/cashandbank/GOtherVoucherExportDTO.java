...
public class GOtherVoucherExportDTO {
    private UUID id;
    ...
    public GOtherVoucherExportDTO() {
    }

    public GOtherVoucherExportDTO(UUID id , LocalDate date, LocalDate postedDate, String noBook, Integer typeID,

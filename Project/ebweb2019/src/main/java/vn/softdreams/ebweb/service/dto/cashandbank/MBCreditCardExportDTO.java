...
public class MBCreditCardExportDTO {
    private UUID id;
    ...
    public MBCreditCardExportDTO() {
    }

    public MBCreditCardExportDTO(UUID id ,LocalDate date, LocalDate postedDate, String noBook, Integer typeID,
                              String typeIDInWord, String creditCardNumber, String accountingObjectName, String description, BigDecimal totalAmount) {
        this.id = id;
        this.date = date;

...
public class MBCreditCardViewDTO {
    private UUID id;
    ...
    public MBCreditCardViewDTO() {
    }

    public MBCreditCardViewDTO(UUID id, Integer typeID, LocalDate date, LocalDate postedDate, Integer typeLedger, String creditCardNumber,

...
public class SAInvoiceDetailPopupDTO {
    private UUID id;
    ...
    private UUID accountingObjectID2;
    private Integer typeID;
    private Integer refTypeID;

    public SAInvoiceDetailPopupDTO() {
    }

    public SAInvoiceDetailPopupDTO(UUID id, UUID saInvoiceID, UUID materialGoodsID, Boolean isPromotion,
                                   UUID repositoryID, String description, String debitAccount, String creditAccount,
                                   UUID unitID, BigDecimal quantity, BigDecimal unitPrice, BigDecimal unitPriceOriginal,
                                   UUID mainUnitID, BigDecimal mainQuantity, BigDecimal mainUnitPrice,
                                   BigDecimal mainConvertRate, String formula, BigDecimal amount,
                                   BigDecimal amountOriginal, BigDecimal discountRate, BigDecimal discountAmount,
                                   BigDecimal discountAmountOriginal, String discountAccount, BigDecimal vatRate,
                                   BigDecimal vatAmount, BigDecimal vatAmountOriginal, String vatAccount,
                                   String repositoryAccount, String costAccount, BigDecimal owPrice,
                                   BigDecimal owAmount, LocalDate expiryDate, String lotNo, UUID accountingObjectID,
                                   UUID departmentID, UUID expenseItemID, UUID budgetItemID, UUID costSetID,
                                   UUID contractID, UUID statisticsCodeID, String vatDescription, String deductionDebitAccount,
                                   LocalDate date, String noFBook, String noMBook, UUID accountingObjectID2, String reason, Integer typeID) {
        this.id = id;
        ...
        this.accountingObjectID2 = accountingObjectID2;
        this.reason = reason;
        this.typeID = typeID;
    }
    ...
    public UUID getAccountingObjectID2() {
        return accountingObjectID2;
    }

    public void setAccountingObjectID2(UUID accountingObjectID2) {
        this.accountingObjectID2 = accountingObjectID2;
    }

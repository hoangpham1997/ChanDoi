...
@Component({
    ...
    templateUrl: './dieu-chinh-ccdc-delete-dialog.component.html'
})
export class DieuChinhCcdcDeleteDialogComponent {
...
export class DieuChinhCcdcDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ gOtherVoucher }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(DieuChinhCcdcDeleteDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });

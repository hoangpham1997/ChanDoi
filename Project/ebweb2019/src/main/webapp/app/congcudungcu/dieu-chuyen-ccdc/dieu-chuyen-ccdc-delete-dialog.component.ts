...
@Component({
    ...
    templateUrl: './dieu-chuyen-ccdc-delete-dialog.component.html'
})
export class DieuChuyenCcdcDeleteDialogComponent {
...
export class DieuChuyenCcdcDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ gOtherVoucher }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(DieuChuyenCcdcDeleteDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });

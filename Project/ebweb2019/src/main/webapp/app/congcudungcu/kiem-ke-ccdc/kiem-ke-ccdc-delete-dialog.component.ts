...
@Component({
    ...
    templateUrl: './kiem-ke-ccdc-delete-dialog.component.html'
})
export class KiemKeCcdcDeleteDialogComponent {
...
export class KiemKeCcdcDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ gOtherVoucher }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(KiemKeCcdcDeleteDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });

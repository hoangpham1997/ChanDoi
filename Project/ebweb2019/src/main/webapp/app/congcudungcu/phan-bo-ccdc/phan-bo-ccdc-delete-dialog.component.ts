...
@Component({
    ...
    templateUrl: './phan-bo-ccdc-delete-dialog.component.html'
})
export class PhanBoCcdcDeleteDialogComponent {
...
export class PhanBoCcdcDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ gOtherVoucher }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(PhanBoCcdcDeleteDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });

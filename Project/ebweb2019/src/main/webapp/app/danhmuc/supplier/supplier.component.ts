...
export class AccountingObjectComponent extends BaseComponent implements OnInit, OnDestroy {
    ...
    ObjectTypeListes = [{ id: 0, name: 'Nhà Cung Cấp' }, { id: 2, name: 'Khách Hàng/Nhà Cung Cấp' }, { id: 3, name: 'Khác' }];
    ...
    edit() {
        ...
        if (this.selectedRow.id) {
            ...
            this.router.navigate(['./supplier', this.selectedRow.id, 'edit']);
        }
    }
    ...
    delete() {
        ...
        if (this.selectedRows.length > 1) {
            ...
            this.router.navigate(['/supplier', { outlets: { popup: this.selectedRow.id + '/delete' } }]);
        }
    }

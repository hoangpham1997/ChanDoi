...
export class StatisticsCodeComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.statisticsCodeService
            ...
            .subscribe(
                (res: HttpResponse<IStatisticsCode[]>) => this.paginateStatisticsCodes(res.body, res.headers),
    ...
    registerChangeInStatisticsCodes() {
        this.eventSubscriber = this.eventManager.subscribe('statisticsCodeListModification', response => this.loadAll());
    }
    ...
    private paginateStatisticsCodes(data: IStatisticsCode[], headers: HttpHeaders) {

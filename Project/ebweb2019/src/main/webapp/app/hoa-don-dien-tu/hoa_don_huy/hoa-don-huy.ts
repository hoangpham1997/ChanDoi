...
import { DANH_SACH_HOA_DON_HUY, DANH_SACH_HOA_DON_THAY_THE, HINH_THUC_HOA_DON_HOA_DON_DIEN_TU } from 'app/app.constants';
...
@Component({
    selector: 'eb-hoa-don-huy',
    templateUrl: './hoa-don-huy.html',
    styleUrls: ['./hoa-don-huy.css']
})
export class HoaDonHuyComponent implements OnInit {
    currentAccount: any;
    error: any;
    success: any;
    ...
    transition() {
        this.router.navigate(['/hoa-don-huy'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage
    ...
    searchVoucher(search?) {
        ...
        this.einvocieService
            .searchAll({
                ...
                typeEInvoice: DANH_SACH_HOA_DON_HUY
            })
            .subscribe(

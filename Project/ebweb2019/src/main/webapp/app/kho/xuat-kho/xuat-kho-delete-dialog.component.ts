...
@Component({
    ...
    templateUrl: './xuat-kho-delete-dialog.component.html'
})
export class XuatKhoDeleteDialogComponent {
...
export class XuatKhoDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(data => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(XuatKhoDeleteDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
                ...
                this.ngbModalRef.result.then(
                    result => {
                        this.router
                            ...
                            .then(() => this.router.navigate(['xuat-kho']));

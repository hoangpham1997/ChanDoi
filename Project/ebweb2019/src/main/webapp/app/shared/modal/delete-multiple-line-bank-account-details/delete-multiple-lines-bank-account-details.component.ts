...
@Component({
    ...
    templateUrl: 'delete-multiple-lines-bank-account-details.component.html',
    styleUrls: ['delete-multiple-lines-bank-account-details.component.css']
})
export class DeleteMultipleLinesBankAccountDetailsComponent implements OnInit {
    data: HandlingResult;
    modalData: any[];
    typeID: number;

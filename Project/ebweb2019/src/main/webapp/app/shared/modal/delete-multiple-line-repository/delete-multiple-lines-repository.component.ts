...
@Component({
    ...
    templateUrl: 'delete-multiple-lines-repository.component.html',
    styleUrls: ['delete-multiple-lines-repository.component.css']
})
export class DeleteMultipleLinesRepositoryComponent implements OnInit {
    data: HandlingResult;
    modalData: any[];
    typeID: number;

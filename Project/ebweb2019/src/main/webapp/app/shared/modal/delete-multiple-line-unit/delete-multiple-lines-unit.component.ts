...
@Component({
    ...
    templateUrl: 'delete-multiple-lines-unit.component.html',
    styleUrls: ['delete-multiple-lines-unit.component.css']
})
export class DeleteMultipleLinesUnitComponent implements OnInit {
    data: HandlingResult;
    modalData: any[];
    typeID: number;

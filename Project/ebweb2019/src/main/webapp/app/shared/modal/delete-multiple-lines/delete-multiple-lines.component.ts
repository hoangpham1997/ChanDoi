...
@Component({
    ...
    templateUrl: 'delete-multiple-lines.component.html',
    styleUrls: ['delete-multiple-lines.component.css']
})
export class DeleteMultipleLinesComponent implements OnInit {
    data: HandlingResult;
    modalData: any[];
    typeID: number;

    ...
    getReasonFail(reasonFail) {
        switch (reasonFail) {
            case MSGERROR.XUAT_QUA_TON_QUY_QT:
                return this.translate.instant('global.messages.error.checkTonQuyQT');
            case MSGERROR.XUAT_QUA_TON_QUY_TC:
                return this.translate.instant('global.messages.error.checkTonQuyTC');
            case MSGERROR.XUAT_QUA_TON_QUY:
                return this.translate.instant('global.messages.error.checkTonQuy');

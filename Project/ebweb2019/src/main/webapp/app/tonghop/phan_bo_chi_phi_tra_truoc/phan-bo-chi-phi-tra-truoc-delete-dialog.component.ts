...
@Component({
    ...
    templateUrl: './phan-bo-chi-phi-tra-truoc-delete-dialog.component.html'
})
export class PhanBoChiPhiTraTruocDeleteDialogComponent {
...
export class PhanBoChiPhiTraTruocDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ gOtherVoucher }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(PhanBoChiPhiTraTruocDeleteDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });

...
export class PhanBoChiPhiTraTruocService {
    ...
    createPB(ref?: any): Observable<HttpResponse<any>> {
        ...
        return this.http
            .post<IPPDiscountReturn>(this.resourceUrl + '/allocation', copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertDateFromServer(res)));
    }
    ...
    updatePB(ref?: any): Observable<HttpResponse<any>> {
        const copy = this.convertDateFromPBClient(ref);
        return this.http
            .put<IPPDiscountReturn>(this.resourceUrl + '/allocation', copy, { observe: 'response' })
            .pipe(map((res: EntityResponseType) => this.convertDateFromServer(res)));
    }
    ...
    searchAllPB(req?: any): Observable<HttpResponse<any>> {
        const options = createRequestOption(req);
        return this.http
            .get<any[]>(`${this.resourceUrl}/search-all-g-other-vouchers`, {
                params: options,
                observe: 'response'
            })
            .pipe(map((res: EntityArrayResponseType) => this.convertDateArrayFromServer(res)));
